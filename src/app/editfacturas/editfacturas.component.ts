...
export class EditfacturasComponent implements OnInit {
  ...
  formafb() {
    this.editfacturas = this.fb.group({
        ...
        .subscribe( 
            data => {
                ...
                if (this.datawork.cr=="00"){
                    ...
                    this.editfacturas.controls['idCliProv'           ].setValue(this.currentFacturas.idCliProv           );
                    this.editfacturas.controls['numPart'             ].setValue(this.currentFacturas.idCliProv           );
                    this.editfacturas.controls['numPedimentoEntrada' ].setValue(this.currentFacturas.numPedimentoEntrada );
                    this.editfacturas.controls['numFact'             ].setValue(this.currentFacturas.numFact             );
                    this.editfacturas.controls['fechaEntrada'        ].setValue(this.currentFacturas.fechaEntrada        );
                    this.editfacturas.controls['tipCambio'           ].setValue(this.currentFacturas.tipoCambio          );                    
                    this.editfacturas.controls['nUMGuia'             ].setValue(this.currentFacturas.nUMGuia             );
                    this.editfacturas.controls['nUMPlacaTr'          ].setValue(this.currentFacturas.nUMPlacaTr          );
                    this.editfacturas.controls['contCaja'            ].setValue(this.currentFacturas.contCaja            );
                    this.editfacturas.controls['selloCand1'          ].setValue(this.currentFacturas.selloCand1          );
                    this.editfacturas.controls['selloCand2'          ].setValue(this.currentFacturas.selloCand2          );
                    this.editfacturas.controls['selloCand3'          ].setValue(this.currentFacturas.selloCand3          );
                    this.editfacturas.controls['NombChofTR'          ].setValue(this.currentFacturas.nombChofTr          );
                    this.editfacturas.controls['po'                  ].setValue(this.currentFacturas.pO                  );
                    this.editfacturas.controls['observaciones'       ].setValue(this.currentFacturas.observaciones       );
                    ...
                    if(this.iDImpoEexpo == '1'){
                      ...
                      this.editfacturas.controls['gender'].setValue('2');
                    }                    
                }else{
                    this.loading = false;
  ...
  // convenience getter for easy access to form fields
    get f() { return this.editfacturas.controls; }


  enviar() {
    if (this.editfacturas.invalid) {
        ...
        this.armausuario();
        console.log("editfacturas.component.ts enviar currentFacturas")
